...
public enum RabbitmqComponentConstants {
    ...
    GROUP_ACCEPT_NOTIFICATION_QUEUE("notification.groupAccept.queue", "fail.notification.groupAccept.queue"),
    GROUP_ACCEPT_NOTIFICATION_EXCHANGE("notification.groupAccept.exchange", "fail.notification.groupAccept.exchange");
