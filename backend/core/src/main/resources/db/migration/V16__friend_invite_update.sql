...
ALTER TABLE friend_invite DROP CONSTRAINT fk_friend_invite_member_id;
ALTER TABLE friend_invite DROP COLUMN member_id;

ALTER TABLE friend_invite ADD COLUMN owner_id BIGINT;
ALTER TABLE friend_invite ADD COLUMN friend_id BIGINT;
