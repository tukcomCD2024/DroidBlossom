package site.timecapsulearchive.core.domain.capsule.api.group_c;
...
import site.timecapsulearchive.core.domain.capsule.data.group_c.reqeust.GroupCapsuleCreateRequest;
import site.timecapsulearchive.core.domain.capsule.data.group_c.reqeust.GroupCapsuleUpdateRequest;
import site.timecapsulearchive.core.domain.capsule.data.group_c.response.GroupCapsuleDetailResponse;
import site.timecapsulearchive.core.domain.capsule.data.group_c.response.GroupCapsulePageResponse;
import site.timecapsulearchive.core.domain.capsule.data.group_c.response.GroupCapsuleSummaryResponse;
