...
public enum ErrorCode {
    ...
    GROUP_MEMBER_EXIST_ERROR(400, "GROUP-005", "다른 그룹 멤버가 존재해 그룹을 삭제할 수 없습니다."),
    NO_GROUP_AUTHORITY_ERROR(403, "GROUP-006", "그룹에 대한 권한이 존재하지 않습니다."),
    GROUP_CAPSULE_EXIST_ERROR(400, "GROUP-007", "그룹 캡슐이 존재해 그룹을 삭제할 수 없습니다."),
