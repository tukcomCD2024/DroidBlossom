...
import site.timecapsulearchive.core.domain.capsule.data.response.CapsuleSummaryResponse;
...
import site.timecapsulearchive.core.domain.capsule.data.secret_c.response.MySecreteCapsuleResponse;
