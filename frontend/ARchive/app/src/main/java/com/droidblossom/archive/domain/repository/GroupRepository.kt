...
interface GroupRepository {
    ...
    suspend fun deleteRejectGroupInviteRequest(groupId: Long): RetrofitResult<String>
    ...
    suspend fun deleteGroupMember(groupId: Long, groupMemberId: Long): RetrofitResult<String>
}