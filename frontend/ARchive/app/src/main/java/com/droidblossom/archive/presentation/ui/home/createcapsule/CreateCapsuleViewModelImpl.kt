...
class CreateCapsuleViewModelImpl @Inject constructor(
    ...
    private val _createEvents = MutableSharedFlow<CreateCapsuleViewModel.CreateEvent>()
    override val createEvents: SharedFlow<CreateCapsuleViewModel.CreateEvent>
        get() = _createEvents.asSharedFlow()
